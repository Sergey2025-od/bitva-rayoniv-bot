...
function buildPaymentMessage(label, code) {
  return (
    `💳 <b>Донат-голосування</b>\n\n` +
    `🏆 ${label}\n\n` +
    `━━━━━━━━━━━━━━━\n` +
    `📋 <b>Ваш унікальний код:</b>\n\n` +
    `<code>${code}</code>\n\n` +
    `👆 <i>Натисніть на код — він скопіюється автоматично</i>\n` +
    `━━━━━━━━━━━━━━━\n\n` +
    `<b>Як проголосувати:</b>\n` +
    `1️⃣ Скопійте код вище\n` +
    `2️⃣ Натисніть кнопку 💳 ВІДКРИТИ MONO\n` +
    `3️⃣ Введіть будь-яку суму\n` +
    `4️⃣ Вставте код у поле <b>«Коментар»</b>\n` +
    `5️⃣ Підтвердіть платіж\n\n` +
    `💸 1 грн = 1 голос\n` +
